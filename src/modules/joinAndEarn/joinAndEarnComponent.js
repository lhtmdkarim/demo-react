...
function JoinAndEarnComponent(){
    return (
        <div className="p-8 md:pt-20.5 md:pb-21.25 md:px-0">
            <div className="text-black-50 text-ft8 font-semibold text-center md:text-left">Join and Earn</div>
            <div className="mt-4.5 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="py-7.75 px-9.5 bg-grey-50">
                    <div className="text-ft6 text-black-50 font-semibold">For Game Designers</div>
...
export default JoinAndEarnComponent;
